#ifndef BIT_VEC64_SUITE_HPP
#define BIT_VEC64_SUITE_HPP

#include <cppunit/extensions/HelperMacros.h>
#include "syskit/macros.h"

DECLARE_CLASS1(syskit, BitVec64)


class BitVec64Suite: public CppUnit::TestFixture
{

public:
    BitVec64Suite();

    virtual ~BitVec64Suite();

private:
    syskit::BitVec64* vec0_;
    syskit::BitVec64* vec1_;
    syskit::BitVec64* vec2_;
    syskit::BitVec64* vec3_;

    CPPUNIT_TEST_SUITE(BitVec64Suite);
    ...
    BitVec64Suite(const BitVec64Suite&); //prohibit usage
    const BitVec64Suite& operator =(const BitVec64Suite&); //prohibit usage
