...
// - unsigned int U16Vec::add(size_t count, item_t item);
//
...
//
// Interfaces under test:
// - unsigned int U16Vec::add(const item_t* raw, size_t itemCount);
//
...
//
// Interfaces under test:
// - U16Vec::item_t* U16Vec::detachRaw(unsigned int& numItems);
