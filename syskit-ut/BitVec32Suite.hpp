#ifndef BIT_VEC32_SUITE_HPP
#define BIT_VEC32_SUITE_HPP

#include <cppunit/extensions/HelperMacros.h>
#include "syskit/macros.h"

DECLARE_CLASS1(syskit, BitVec32)


class BitVec32Suite: public CppUnit::TestFixture
{

public:
    BitVec32Suite();

    virtual ~BitVec32Suite();

private:
    syskit::BitVec32* vec0_;
    syskit::BitVec32* vec1_;
    syskit::BitVec32* vec2_;
    syskit::BitVec32* vec3_;

    CPPUNIT_TEST_SUITE(BitVec32Suite);
    ...
    BitVec32Suite(const BitVec32Suite&); //prohibit usage
    const BitVec32Suite& operator =(const BitVec32Suite&); //prohibit usage
