...
// - unsigned int U64Vec::add(size_t count, item_t item);
//
...
//
// Interfaces under test:
// - unsigned int U64Vec::add(const item_t* raw, size_t itemCount);
//
...
//
// Interfaces under test:
// - U64Vec::item_t* U64Vec::detachRaw(unsigned int& numItems);
